...
<body>
	...
	$databasename = "PillowTeethCompany";
	$username = "root";
	$password = "root";
...
the code in catch-block is executed. */
	...
	try {
		$sql = "CREATE DATABASE PillowTeethCompany;";   // SQL query

		$conn->exec($sql);
		echo "<p style='color:green'>Database Created Successfully\nDatabase Pillow Teeth Company</p>";
	} catch (PDOException $err) {
